...
## Project Structure
    ...
    ├── testapiautoconnecto_96100  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_96100`
...
2. Clone this repo and `cd testapiautoconnecto_96100`
